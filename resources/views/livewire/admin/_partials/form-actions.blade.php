{{-- FORM FOOTER --}}
<div class="mt-8 pt-6 border-t border-slate-200 flex items-center justify-between form-actions">

    {{-- LEFT ACTIONS --}}
    <div class="flex items-center gap-4 form-acttions-buttons">
        @if(!$id)
        {{-- Save & add new --}}
        <div class="hs-tooltip inline-block">
            ...
            <span
                ...
                role="tooltip"
            >
                {{ __('Save and continue with a new') }}
            </span>
        </div>
        @endif
        {{-- Save --}}
