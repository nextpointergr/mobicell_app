...
class SyncPrestashopPaymentsJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $this->performUpsert('prestashop', 'payments', $items);
    ...
    private function finish(SyncRun $run): void
    {
        ...
        ExternalSync::updateOrCreate(
            ['source' => 'prestashop', 'entity' => 'payments'],
            ['last_synced_at' => now()]
        );
